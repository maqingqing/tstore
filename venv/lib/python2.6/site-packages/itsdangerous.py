...
"""
    ...
    sources.  Mainly useful for app applications.
...
class TimedJSONWebSignatureSerializer(JSONWebSignatureSerializer):
    ...
    similarily as specified in `draft-ietf-oauth-json-app-token
    <http://self-issued.info/docs/draft-ietf-oauth-json-app-token.html#expDef`_.
