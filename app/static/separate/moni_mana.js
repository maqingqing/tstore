  ...
  //                text: '内存使用率(%, '+getMemsize(COUNT)+'G)'
		...
		$(RWid).highcharts('StockChart', {
	        ...
	        series: [{
	        	...
	        	data: (function () {
					...
					var initArr = cluster_info_wr[COUNT]["init_disk_read_data"];
	        	...
	        	data: (function () {
	          		var data = [], time = (new Date()).getTime(),j;
					var initArr = cluster_info_wr[COUNT]["init_disk_write_data"];
					var initLength = initArr.length;
					var hopeLength = 360;
					if(initLength<hopeLength){
						for (var i = initLength; i < hopeLength; i++) {
		...
		$(NETid).highcharts('StockChart', {
	        ...
	        series: [{
		        ...
		        data: (function () {
		          	var data = [],time = (new Date()).getTime(),j;
		          	var initArr = cluster_info_wr[COUNT]["init_network_in_data"];
					var initLength = initArr.length;
					var hopeLength = 360;
					if(initLength<hopeLength){
						for (var i = initLength; i < hopeLength; i++) {
	        	...
	        	data: (function () {
	          		...
	          		var initArr = cluster_info_wr[COUNT]["init_network_out_data"];
					var initLength = initArr.length;
					var hopeLength = 360;
					if(initLength<hopeLength){
						for (var i = initLength; i < hopeLength; i++) {
